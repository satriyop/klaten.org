...
export const SPORTS_CATEGORIES: SportCategory[] = [
  ...
  },
  {
    ...
    status: 'open',
    statusText: 'Buka Pendaftaran Klub',
    clubCountText: 'Slot Subdomain Basket Tersedia',
    description: 'Klub dan akademi bola basket usia dini hingga remaja di Klaten untuk jadwal latihan rutin di GOR Gelarsena atau lapangan lokal.',
    roadmapSlug: 'basket',
  },
  {
    id: 'panahan',
    ...
    status: 'open',
    statusText: 'Buka Pendaftaran Klub',
    clubCountText: 'Slot Subdomain Panahan Tersedia',
    description: 'Klub panahan prestasi maupun tradisional (jemparingan) di Klaten, didukung sarana resmi seperti Lapangan Panahan Jonggrangan.',
    roadmapSlug: 'panahan',
  },
  {
    id: 'voli',
    ...
    status: 'open',
    statusText: 'Buka Pendaftaran Klub',
    clubCountText: 'Slot Subdomain Voli Tersedia',
    description: 'Cabang olahraga yang sangat merakyat di Klaten untuk pembinaan tim usia dini, klub voli kecamatan, dan turnamen daerah.',
    roadmapSlug: 'voli',
  },
  {
    id: 'beladiri',
    ...
    status: 'open',
    statusText: 'Buka Pendaftaran Klub',
    clubCountText: 'Slot Subdomain Dojang/Dojo Tersedia',
    description: 'Dojang taekwondo, dojo karate, dan perguruan silat di Klaten untuk pembinaan disiplin anak, ujian kenaikan sabuk, dan kejuaraan.',
    roadmapSlug: 'beladiri',
  },
  {
    id: 'tenis-padel',
    name: 'Tenis & Padel',
